...
def run_test_generate_points_on_circle():
    ...
    expected = [rg.Point(110, 120),
                rg.Point(100, 1300),
                rg.Point(90, 120),
                rg.Point(100, 110)]

    circle = rg.Circle(rg.Point(100, 120), 10)
...
def run_test_pizza():
    ...
    # ------------------------------------------------------------------
    circle = rg.Circle(rg.Point(250, 175), 80)
    circle.fill_color = 'orange'
    pizza(window, circle, 15, 'red', 6)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    # ------------------------------------------------------------------
    circle = rg.Circle(rg.Point(400, 250), 66)
    circle.outline_thickness = 3
    polygon(window, circle, 7, 'orange', 8)
